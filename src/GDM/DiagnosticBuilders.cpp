...
namespace Cryo
{
                                                                       ...
                                                                       const std::string& context)
    {
        ...
        switch (expected) {
            case TokenKind::TK_SEMICOLON: message += "';'"; break;
            case TokenKind::TK_L_PAREN: message += "'('"; break;
            case TokenKind::TK_R_PAREN: message += "')'"; break;
            case TokenKind::TK_L_BRACE: message += "'{'"; break;
            case TokenKind::TK_R_BRACE: message += "'}'"; break;
            case TokenKind::TK_IDENTIFIER: message += "identifier"; break;
            default: message += "token"; break;
        }
                                                                       ...
                                                                       SourceLocation opening_location)
    {
        ...
        switch (delimiter) {
            case ')': error_code = ErrorCode::E0107_EXPECTED_PAREN; break;
            case '}': error_code = ErrorCode::E0108_EXPECTED_BRACE; break;
            case ']': error_code = ErrorCode::E0109_EXPECTED_BRACKET; break;
                                                                         ...
                                                                         SourceLocation location)
    {
        ...
        ErrorCode error_code = (actual_args > expected_args) ? 
                              ErrorCode::E0215_TOO_MANY_ARGS : ErrorCode::E0216_TOO_FEW_ARGS;
