D31 population: 1364 distinct sites
  compiler/src        165   ident=139  member=19  scope=7
  examples              8   ident=1  member=3  scope=4
  stdlib              480   ident=268  member=40  scope=172
  tests/negative       26   ident=25  member=0  scope=1
  tests/projects       61   ident=37  member=8  scope=16
  tests/unit          571   ident=449  member=85  scope=37
  tools/CryoLSP        53   ident=36  member=17  scope=0
  by shape: ident=955  member=172  scope=237
  ident by follower: bare=8  call=142  scope-step=586  struct-lit=219
  files: 272
  ...
  ident sites the scan alone decided (not declared generic in the writing module): 567
    ...
    compiler/src     compiler/src/compiler/passes/specialization.cryo:276:51  Box
    ...
    compiler/src     compiler/src/compiler/sema/call_resolver.cryo:2831:46  Slice
    ...
    compiler/src     compiler/src/compiler/sema/sema.cryo:3900:42  Box
    ...
    compiler/src     compiler/src/compiler/types/Resolver.cryo:110:36  Pair
    ...
    compiler/src     compiler/src/compiler/types/generic_registry.cryo:1118:26  Pair
    compiler/src     compiler/src/compiler/types/generic_registry.cryo:354:32  HashMap
    compiler/src     compiler/src/compiler/types/generic_registry.cryo:355:32  HashMap
    compiler/src     compiler/src/compiler/types/generic_registry.cryo:358:32  HashMap
    compiler/src     compiler/src/compiler/types/generic_registry.cryo:359:32  HashMap
    compiler/src     compiler/src/compiler/types/generic_registry.cryo:362:32  HashMap
    compiler/src     compiler/src/compiler/types/generic_registry.cryo:364:32  HashMap
    compiler/src     compiler/src/compiler/types/generic_registry.cryo:365:32  HashMap
    compiler/src     compiler/src/compiler/types/generic_registry.cryo:368:35  HashMap
    compiler/src     compiler/src/compiler/types/generic_registry.cryo:373:30  HashMap
    compiler/src     compiler/src/compiler/types/resolver.cryo:110:36  Pair
