...
CLASS_OF_METHOD = {
    ...
    "DeclarationIndex::intrinsic_owner_of":
        ("W", "the callee's WRITTEN leaf asked for the intrinsic it may name, then compared with the pin; the pin's entry could carry the intrinsic mark and retire the read"),
