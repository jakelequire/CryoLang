...
namespace Cryo::Codegen
{
     ...
     * These functions are defined in `./stdlib/core/intrinsics.cryo`.
     */
    class Intrinsics
    {
    public:
        ...
        llvm::Value *generate_fdopen(const std::vector<llvm::Value *> &args);
        ...
        llvm::Value *generate_popen(const std::vector<llvm::Value *> &args);
        llvm::Value *generate_pclose(const std::vector<llvm::Value *> &args);
