...
#define ERROR_CODE_LIST(X)                          \
    ...
    X(E0634_VARIABLE_INITIALIZATION_ERROR, 634)     \
    X(E0635_TYPE_CONSTRUCTOR_UNDEFINED, 635)        \
    X(E0636_UNDEFINED_FUNCTION_CALL, 636)           \
    X(E0637_INVALID_GENERIC_INSTANTIATION, 637)     \
    X(E0638_INVALID_STRUCT_INITIALIZATION, 638)     \
